define(['controllers/controllers'],
  function(controllers) {
    controllers.controller('UpdateMeetingCont', ['$window',
      '$scope',
      '$http',
      function(
        $window,
        ...
        $http.post("http://162.243.18.170:9000/v1/meeting/get", data).success(function(data, status) {
          ...
          var t = new Date(data.result.meeting.datetime);
          var tempYear = t.getFullYear();
          ...
          $scope.date = tempYear+"-"+tempMonth+"-"+tempDay;
